		      ...
		      <div class="card-body">
		        <form action="proses_tambah_matpel.php" method="POST">
		        	<div class="form-group">
					    ...
					    <input type="text" class="form-control" name="id_matpel" placeholder="ID Matpel">
					</div>

					<div class="form-group">
						<label for="nama_matpel">Nama Matpel:</label>
					    <input type="text" class="form-control" name="nama_matpel" placeholder="Nama Matpel">
					</div>

					<div class="form-group">
						<label for="status_pelajaran">Status Pelajaran:</label>
					    <input type="text" class="form-control" name="status_pelajaran" placeholder="Status Pelajaran">
					</div>
