        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="tambah_matpel.php" class="btn btn-primary mb-2"> + Tambah</a>
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th scope="col">ID Matpel</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                while($matpel = mysqli_fetch_array($query)){
                                    ...
                                    echo "<td>".$matpel['status_pelajaran']."</td>";

                                    echo "<td>";
                                    echo "<a href='edit_matpel.php?id=".$matpel['id_matpel']."'>Edit</a> | ";
                                    echo "<a href='hapus_matpel.php?id=".$matpel['id_matpel']."'>Hapus</a>";
                                    echo "</td>";
