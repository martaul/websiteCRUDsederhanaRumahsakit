                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="tambah_guru.php" class="btn btn-primary mb-2">Tambah</a>
                        </div>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($guru = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>".$guru['tgl_lahir']."</td>";
                                            echo "<td>".$guru['alamat']."</td>";
                                            echo "<td>".$guru['no_ktp']."</td>";
                                            echo "<td>".$guru['status_keluarga']."</td>";
                                            echo "<td>".$guru['id_jabatan']."</td>";
                                            echo "<td>".$guru['foto']."</td>";
                                            echo "<td>".$guru['status_pegawai']."</td>";

                                            echo "<td>";
                                            echo "<a href='edit_guru.php?id=".$guru['id_guru']."'>Edit</a> | ";
                                            echo "<a href='hapus_guru.php?id=".$guru['id_guru']."'>Hapus</a>";
                                            echo "</td>";
