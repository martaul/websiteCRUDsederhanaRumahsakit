				      ...
				      <div class="card-body">	
				        <form action="proses_tambah_siswa.php" method="POST">
							...
							<div class="form-group">
							    ...
							    <input type="text" class="form-control" name="nama_siswa" placeholder="nama_siswa">
							</div>
							...
							<div class="form-group">
							    ...
							    <input type="text" class="form-control" name="pekerjaan_ortu" placeholder="pekerjaan_ortu">
							</div>
