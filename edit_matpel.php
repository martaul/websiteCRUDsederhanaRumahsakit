...
$sql = "SELECT * FROM matpel WHERE id_matpel='$id_matpel'";
$query = mysqli_query($db, $sql);
$matpel = mysqli_fetch_assoc($query);
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="data_mata_pelajaran.php" class="nav-link active">
    ...
    <div class="container">
	  <div class="card mb-3" style="max-width: 1000px;">
		  <div class="row no-gutters">
		    ...
		    <div class="col-lg-7">
		      <div class="card-body">
		        <form action="proses_edit_matpel.php" method="POST">
		        <input type="hidden" name="id_matpel" value="<?php echo $matpel['id'] ?>" />

		        	<div class="form-group">
						<label for="id_matpel">ID Matpel:</label>
					    <input type="text" class="form-control" name="id_matpel" value="<?php echo $matpel['id_matpel'] ?>" >
					</div>

					<div class="form-group">
						<label for="nama_matpel">Nama Matpel:</label>
					    <input type="text" class="form-control" name="nama_matpel" value="<?php echo $matpel['nama_matpel'] ?>" >
					</div>

					<div class="form-group">
						<label for="status_pelajaran">Status Pelajaran:</label>
					    <input type="text" class="form-control" name="status_pelajaran" value="<?php echo $matpel['status_pelajaran'] ?>" >
					</div>
