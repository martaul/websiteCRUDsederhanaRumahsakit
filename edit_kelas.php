...
$sql = "SELECT * FROM mkelas WHERE id_kelas='$id_kelas'";
		      ...
		      <div class="card-body">	
		        ...
		        <input type="hidden" name="id_kelas" value="<?php echo $kelas['id'] ?>" />
		        	...
		        	<div class="form-group">
					    ...
					    <input type="text" class="form-control" name="id_kelas" placeholder="ID kelas" value="<?php echo $kelas['id_kelas'] ?>">
					</div>
					...
					<div class="form-group">
					    ...
					    <input type="text" class="form-control" name="id_guru" placeholder="id_guru " value="<?php echo $kelas['id_guru'] ?>">
					</div>

					<div class="form-group">
						<label for="nis">nis:</label>
					    <input type="text" class="form-control" name="nis" placeholder="nis " value="<?php echo $kelas['nis'] ?>">
					</div>

					<div class="form-group">
						<label for="id_tahun_ajaran">id_tahun_ajaran:</label>
					    <input type="number" class="form-control" name="id_tahun_ajaran" placeholder="id_tahun_ajaran " value="<?php echo $kelas['id_tahun_ajaran'] ?>">
					</div>
