                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Pekerjaan Ortu</th>
                                        <th scope="col">Tindakan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM msiswa";
                                        ...
                                        while($siswa = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>".$siswa['nama_ortu']."</td>";
                                            echo "<td>".$siswa['pekerjaan_ortu']."</td>";

                                            echo "<td>";
                                            echo "<a href='edit_siswa.php?id=".$siswa['nis']."'>Edit</a> | ";
                                            echo "<a href='hapus_siswa.php?id=".$siswa['nis']."'>Hapus</a>";
                                            echo "</td>";
